...
export default {
    data() {
        return {
            ...
            xprops: {
                module: 'PropiedadesIndex',
                route: 'propiedades',
                permission_prefix: 'propiedade_'
            }
        }
    },
    created() {
    ...
    computed: {
        ...mapGetters('PropiedadesIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('PropiedadesIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
